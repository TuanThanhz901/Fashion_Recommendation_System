...
def parse_args():
    ...
    parser.add_argument('--dataset', nargs='?', default='amazon_books2023',
                        help='Choose a dataset from {ciao, epinions, amazon_books2023, amazon_movies2023, amazon_home2023}')
    ...
    parser.add_argument('--mess_dropout', nargs='?', default='[0.1]',
                        help='Keep probability w.r.t. message dropout (i.e., 1-dropout_ratio) for each deep layer. 1: '
                             'no dropout.')
    parser.add_argument('--Ks', nargs='?', default='[1,2,5,10,15,20,30,50,75,100]',
